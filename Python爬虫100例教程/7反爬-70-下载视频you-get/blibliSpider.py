...
需求：抓取blibli视频
技术：you-get, 抓包
【注意】此案例只用于针对某一个 bilibili 视频，进行下载，不通用
'''
...
2、可以看出视频与音频有各自的请求
3、那么可以通过抓包工具 拦截请求，修改请求参数（即修改Range参数），一次性将视频全部请求下来
4、保存
5、上面步骤可以作为分析原理，然后是写代码实现
'''
# 代码实现
'''
在抓包工具中发现：
    1、视频请求有 OPTION请求，状态码是200；有get请求，状态码是206；两者请求的url相同（分视频与音频的url）
    2、需要用到session保持会话
...
## 方法4
'''
直接访问手机Web站了 ，访问地址换成 https://m.bilibili.com/video/BV1wZ4y1R7gH,
抓包，直接查看源码，直接是一个MP4文件
'''
